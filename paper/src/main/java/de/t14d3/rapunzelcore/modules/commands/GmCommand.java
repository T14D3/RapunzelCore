    ...
    public void register() {
        new CommandAPICommand("gm")
                ...
                .executes((executor, args) -> {
                    ...
                    if (target == null) {
                        executor.sendMessage(RapunzelCore.getInstance().getMessageHandler().getMessage("commands.gm.error.invalid", args.getRaw("player")));
                    ...
                    try {
                        ...
                        try {
                            ...
                            executor.sendMessage(RapunzelCore.getInstance().getMessageHandler().getMessage("commands.gm.error.invalid", gamemode));
                            return Command.SINGLE_SUCCESS;
                        }
                    }
                    Component message = RapunzelCore.getInstance().getMessageHandler().getMessage("commands.gm.success",
