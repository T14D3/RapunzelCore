...
public class Utils {
    ...
    public static TagResolver itemResolver(Player player) {
        return TagResolver.resolver("item", (args, context) -> {
            ...
            Component result = RapunzelCore.getInstance().getMessageHandler().getMessage("general.component.item", ph -> ph
                    .component("icon", Component.object(ObjectContents.sprite(atlas, icon)))
                    .component("name", name)
    ...
    public static PlayerEntity player(org.bukkit.command.CommandExecutor player) {
        return player((Player) player);
    }
    public static PlayerEntity player(org.bukkit.command.CommandSender player) {
        return player((Player) player);
    }
    ...
    public static void updatePlayer(Player player, PlayerEntity playerEntity) {
